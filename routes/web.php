...
Route::get('/About', function () { return view('partials.about'); });
Route::get('/Courses', function () { return view('partials.courses'); });
Route::get('/Blog', function () { return view('partials.blog'); });
...
Route::middleware(['auth'])->group(function () {
    ...
    // Teachers
    Route::get('/teachers/add', function () { return view('teachers.add'); })->name('teacher.create.show');
    ...
    // Library
    Route::get('library/teacher/index', [LibraryController::class, 'showTeachersLibrarySection'])->name('library.teacher.show');
    Route::get('library/student/index', [LibraryController::class, 'showStudentsLibrarySection'])->name('library.student.show');
    ...
    Route::get('/view/pdf/{filename}', [LibraryController::class, 'viewPdf'])->name('view.pdf');
    Route::delete('book/{id}', [BookController::class, 'destroy'])->name('book.destroy');
    Route::get('library/student/books', [LibraryController::class, 'showBookSection'])->name('library.student.books');

    // Videos
    Route::get('/teacher/videos', [VideoController::class, 'showTeacherVideos'])->name('videos.teacher.index');
    Route::get('/student/videos', [VideoController::class, 'showStudentVideos'])->name('videos.student.index');
    Route::post('/teacher/videos/search', [VideoController::class, 'searchTr'])->name('videos.search.tr');
    Route::post('/student/videos/search', [VideoController::class, 'searchSt'])->name('videos.search.st');
    Route::post('/teacher/videos/store', [VideoController::class, 'store'])->name('videos.store');
    Route::get('/teacher/videos/add', [VideoController::class, 'addVideo'])->name('videos.add');
    Route::delete('/teacher/videos/{id}', [VideoController::class, 'destroy'])->name('videos.destroy');

    // Gallery
    Route::get('/student/gallery', [GalleryController::class, 'showStudentGallery'])->name('gallery.student.show');
    Route::get('/teacher/gallery', [GalleryController::class, 'showTeacherGallery'])->name('gallery.teacher.show');
    Route::get('/photos/upload', [GalleryController::class, 'showUploadForm'])->name('photos.upload');
