                        ...
                        <form class="row g-3" action="{{route('school.student.create')}}" method="POST">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-3-md">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress" name="address" placeholder="634 Gabba Rd." required value="{{old('address')}}">
                                </div>
                                <div class="col-3-md">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputCity" name="city" placeholder="K'la..." required value="{{old('city')}}">
                                </div>
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="inputNationality" name="nationality" placeholder="e.g. Ugandan, Ugandese, ..." required value="{{old('nationality')}}">
                                </div>
                                <div class="col-md-4">
