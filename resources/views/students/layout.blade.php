...
<head>
    ...
    <title>{{ config('app.name', 'PlayLearnKids') }}</title>

    <link rel="shortcut icon" href="{{ asset('pages/images/favicon.png') }}">
    <!--<link rel="shortcut icon" sizes="16x16" href="{{ asset('pages/images/favicon.png') }}">
    <link rel="shortcut icon" sizes="32x32" href="{{ asset('pages/images/favicon.png') }}">
        ...
        <nav class="navbar sticky-top navbar-expand-md navbar-light bg-white border-btm-e6">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <i class="bi bi-house"></i> {{ config('app.name', 'PlayLearnKids') }}
                </a>
