                    ...
                    <div class="mb-4">
                        <form class="row g-3" action="{{route('school.teacher.create')}}" method="POST">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="inputCity" name="city" placeholder="Cairo..." required value="{{old('city')}}">
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="inputNationality" name="nationality" placeholder="e.g. American, British, ..." required value="{{old('nationality')}}">
                            </div>
                            <div class="col-12">
