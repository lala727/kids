<div class="col-xs-1 col-sm-1 col-md-1 col-lg-2 col-xl-2 col-xxl-2 border-rt-e6 px-0">
    <div class="d-flex flex-column align-items-center align-items-sm-start ">
                <ul class="nav flex-column pt-2 w-100">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('library.teacher.show', ['teacher_id' => Auth::user()->id])}}" aria-disabled="true"><i class="bi bi-journals"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Library</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('gallery.teacher.show', ['teacher_id' => Auth::user()->id])}}" aria-disabled="true"><i class="bi bi-images"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Gallery</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('videos.teacher.index', ['teacher_id' => Auth::user()->id])}}"><i class="bi bi-play-btn"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Videos</span></a>
                    </li><!--<li class="nav-item">
                        <a class="nav-link disabled" href="#"><i class="bi bi-chat-dots"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Chat</span></a>
                    </li>-->
                    @endif
                    @if(Auth::user()->role == "student")
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a type="button" href="#teacher-submenu" data-bs-toggle="collapse" class="d-flex nav-link {{ request()->is('teachers*')? 'active' : '' }}"><i class="bi bi-journal-text"></i> <span class="ms-2 d-inline d-sm-none d-md-none d-xl-inline">Library</span>
                            <i class="ms-auto d-inline d-sm-none d-md-none d-xl-inline bi bi-chevron-down"></i>
                        </a>
                        <ul class="nav collapse {{ request()->is('teachers*')? 'show' : 'hide' }} bg-white" id="teacher-submenu">
                            <li class="nav-item w-100"><a class="nav-link" href="{{route('library.student.books', ['student_id' => Auth::user()->id])}}"><i class="bi bi-journal-text me-2"></i> Books </a></li>
                            <li class="nav-item w-100"><a class="nav-link" href="{{route('videos.student.index', ['teacher_id' => Auth::user()->id])}}"><i class="bi bi-play-btn me-2"></i> Videos </a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('gallery.student.show', ['student_id' => Auth::user()->id])}}" aria-disabled="true"><i class="bi bi-images"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Gallery</span></a>
                    </li><!--<li class="nav-item">
                        <a class="nav-link disabled" href="#"><i class="bi bi-chat-dots"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Chat</span></a>
                    </li>--><li class="nav-item">
                        <a class="nav-link" href="https://www.adaptedmind.com/Math-Worksheets.html?utm_medium=cpc&utm_source=google&campaignid=16097117425&campaign_type=display&placement=d&utm_content=&adid=687634257065&adset_id=132704324293&utm_term=math%20games&ad_position=&device=c&gclid=CjwKCAjww_iwBhApEiwAuG6ccBiXX6QNsf9A-6t5dp2lzR_38S4r742pgjQE-kWep0zD4aFpk8lp4RoCFrsQAvD_BwE"><i class="bi bi-controller"></i> <span class="ms-1 d-inline d-sm-none d-md-none d-xl-inline">Games</span></a>
                    </li>{{--
                    <li class="nav-item">
