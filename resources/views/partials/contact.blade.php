...
@include('partials.header')
    ...
    <!--====== HEADER PART ENDS ======-->
        ...
        <section id="page-banner" class="pt-105 pb-130 bg_cover" data-overlay="8" style="background-image: url('{{ asset('pages/images/page-banner-1.jpg') }}')">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
